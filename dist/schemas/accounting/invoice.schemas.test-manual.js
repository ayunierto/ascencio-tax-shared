...
const createTest1 = invoice_schemas_1.createInvoiceSchema.safeParse({
    fromCompanyId: '',
    billToName: 'John Doe',
...
const updateTest1 = invoice_schemas_1.updateInvoiceSchema.safeParse({
    description: '',
    notes: '',
    logoUrl: '',
    taxRate: 13,
...
console.log('\nTest 3: Update invoice with undefined values');
const updateTest2 = invoice_schemas_1.updateInvoiceSchema.safeParse({
...
const updateTest3 = invoice_schemas_1.updateInvoiceSchema.safeParse({
    taxRate: 15,
    lineItems: [
        {
...
const updateTest4 = invoice_schemas_1.updateInvoiceSchema.safeParse({
    billToAddress: '',
    billToCity: '',
    billToProvince: '',
    billToPostalCode: '',
...
const updateTest5 = invoice_schemas_1.updateInvoiceSchema.safeParse({
...
const updateTest6 = invoice_schemas_1.updateInvoiceSchema.safeParse({
    fromCompanyId: '123e4567-e89b-12d3-a456-426614174000',
    billToClientId: '',
    billToName: 'John Doe',
    billToEmail: 'john@example.com',
...
const updateTest7 = invoice_schemas_1.updateInvoiceSchema.safeParse({
    taxRate: '13', // Should be number, not string
});
console.log('Result:', updateTest7.success
    ? '❌ FAIL (should reject)'
    : '✅ PASS (correctly rejected)');
// Test 9: Update with lineItems having invalid quantity
console.log('\nTest 9: Invalid - negative quantity');
const updateTest8 = invoice_schemas_1.updateInvoiceSchema.safeParse({
    lineItems: [
        {
            description: 'Service',
...
console.log('Result:', updateTest8.success
    ? '❌ FAIL (should reject)'
    : '✅ PASS (correctly rejected)');
